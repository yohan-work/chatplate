...
const AMBIGUITY_RULES: AmbiguityRule[] = [
  ...
  { pattern: /(?:누구|어디).*(?:물어|문의)/u, excludedBy: /(?:카카오|상담|개인정보|기록|신청\s*채널|문의\s*채널|연락)/u, candidateIds: ['consultation-001', 'privacy-005'], prompt: '상담 신청 채널과 상담 기록 담당 범위 중 어느 쪽을 확인하실까요?' },
